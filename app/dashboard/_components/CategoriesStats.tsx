...
function CategoriesStats({userSettings, from, to} : Props) {
  ...
  return (
    <div className='flex w-full flex-wrap gap-2 md:flex-nowrap px-8 mt-2'>
...
function CategoriesCard({data, type, formatter} : {
    ...
    return (
        <Card className='h-80 w-full col-span-6 '>
            <CardHeader>
                <CardTitle className='grid grid-flow-row justify-between gap-2 text-muted-foreground md:grid-flow-col px-3'>
            ...
            <div className="flex items-center justify-between gap-2">
                ...
                {filteredData.length > 0 && (
                    <ScrollArea className='h-50 w-full px-4'>
